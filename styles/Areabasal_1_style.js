...
var style_Areabasal_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 0.661200 && value <= 10.980000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.091000 && value <= 0.661200) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 8.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.042000 && value <= 0.091000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 8.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.018000 && value <= 0.042000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 8.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.001000 && value <= 0.018000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 8.0 + size,
